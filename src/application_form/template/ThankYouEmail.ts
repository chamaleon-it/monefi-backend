        ...
        <tr>
          <td style="padding: 20px; font-size: 16px; line-height: 1.5; color: #333333;">
            ...
            <p style="margin: 0 0 15px 0;">
              Thank you for submitting your client application. We’ve received it and our team is reviewing your information.
            </p>
            <p style="margin: 0 0 15px 0;">
              Your adviser will contact you shortly to discuss next steps or request any additional details if needed.
            </p>
            <p style="margin: 0 0 15px 0;">
